...
public class OBFingerprintProperty //extends FragmentProperty
{
	...
	//	}
	//
	//	public OBFingerprintProperty(FragmentPropertySet set, String name, String smarts, FingerprintType type)
	//	{
	//		super(set, name, "Structural Fragment", smarts, MatchEngine.OpenBabel);
	//		this.type = type;
	//	}
	//
	//	//	@Override
