...
public class SubstructureAligner implements ThreeDAligner
{
	...
	{
		return "OpenBabel Substructure Aligner";
	}

	@Override
	public String getDescription()
	{
		return "Uses the obfit command from OpenBabel to align compounds according to a common substructure.";
	}
			...
			else
			{
				...
				try
				{
					ExternalTool.run(
							...
							tmpAligned,
							null,
							Settings.CV_OBFIT_PATH + " " + cluster.getSubstructureSmarts() + " "
